...
<head>
    ...
    <script src="js/seri_payroll_save.js"></script>
</head>
<style>
    aside {
    ...
    <aside>
        ...
        <div class="flex-grow-1">
            <div class="container border bg-white">
                <h1 class="d-flex justify-content-center m-2" style="font-size:30px;">Barts's Payroll</h1>
                <!-- form inputs -->
                    ...
                    <div class="col">
                        <div class="d-flex justify-content-center align-items-center flex-column">
                            ...
                            <div class="card mb-3 mx-4" style="width: 14rem;">
                                <img src="login pic.png" class="card-img-top" alt="..." height="190">
