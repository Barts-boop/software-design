$(document).readyfunction() 
{
    ...
    $('#save').click(function(e) {
        ...
        var basic_rate_hour = $('#basic_rate_hour').val();
        ...
        var hono_income_cutoff = $('#hono_income_cutoff').val();
        ...
        data_string += '&basic_income cutoff=' + basic_income_cutoff;
        ...
        data_string += '&total_deduction=' + total_deduction
        ...
        $.ajax({
            ...
            success: function(result) {
                if (result.ok) {
                    ...
                    window.location.href= "http://localhost/lpu_web_development/barts%20payroll.php";
                    }
                }
            })
    });
