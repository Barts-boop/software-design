...
$gross_income=(($rate_per_hour*$hours_per_day)*$days_per_week)*$weeks_per_month;
 ...
 ?>
 <form action="employee salary.php" method="POST">
...
SSS Contribution</font></span>
 ...
 <input type="text" name="employer_sss_contri" value="<?php echo
$employer_sss_contri;?>"/>
 <br>
 <span style="margin-left:35px" "paddingtop:3px">Employee SSS Contribution:</span>
 <input type="text" name="employee_sss_contri" value="<?php echo
$employee_sss_contri;?>" />
 <br>
 <span style="margin-left:65px" "padding-top:3px">Total SSS Contribution:</span>
 <input type="text" name="total_sss_contri" value="<?php echo
$total_sss_contri;?>" disabled/>
 <br>
 <br>
 <span style="margin-left:-50px" ><font size="5px" color="dark orange">
...
Philhealth Contribution</font></span><br>
 ...
 <input type="text" name="employee_philhealth_contri" value="<?php echo
$employee_philhealth_contri;?>" /></br>
<span style="margin-left:-4px" "paddingtop:3px">Employer Philhealth Contribution:</span>
 <input type="text" name="employer_philhealth_contri" value="<?php
echo $employer_philhealth_contri;?>" /><br>
 <span style="margin-left:25px" "paddingtop:3px">Total Philhealth Contribution:</span>
 <input type="text" name="total_philhealth_contri" value="<?php 
 echo $total_philhealth_contri;?>" disabled/><br>
 ...
 <input type="text" name="weeks_per_month" value="<?php echo
$weeks_per_month;?>"/>
 <br>
...
disabled />
 ...
 <input type="text" name="monthly_net_income" value="<?php echo
$monthly_net_income;?>" disabled />
 <br>
